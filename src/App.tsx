  ...
  const DEST_EMAIL = "joaobarbosadev@gmail.com";
          ...
          <div className="grid items-center gap-10 pb-16 pt-10 md:grid-cols-2 md:pb-24 md:pt-16">
            ...
            >
              ...
              <p className="mt-4 text-buff/80 leading-relaxed">
                Se você é como o Renato — já viu variáveis, condicionais e laços — mas não sabe transformar isso em
                <span className="font-semibold text-buff"> projeto real</span>, eu te guio passo a passo até a autonomia.
              </p>
      ...
      <Section>
        <Container>
          <div className="grid items-center gap-10 md:grid-cols-[1.1fr_.9fr]">
            ...
            <motion.div className="order-1 md:order-2" initial={{ opacity: 0, x: 20 }} whileInView={{ opacity: 1, x: 0 }}>
              <div className="rounded-2xl border border-buff/20 bg-night p-6">
                ...
                <h3 className="mt-2 text-xl font-semibold">Para quem já tocou no código e quer confiança</h3>
                <p className="mt-3 text-buff/80">
                  A proposta é simples: sair do “exercício de sala” e construir algo útil. Você aprende a aprender,
        ...
        <Container>
          <div className="grid items-start gap-10 md:grid-cols-2">
            <div>
              ...
              <p className="mt-3 text-buff/80">
                Feita para iniciantes com alguma base escolar — como o Renato — que querem transformar o básico em prática.
              </p>
  ...
  function ContactForm() {
    ...
    const mailtoHref = useMemo(() => {
      const subject = encodeURIComponent("Mentoria — Novo contato");
      const body = encodeURIComponent(
        `Olá João, quero saber mais sobre a mentoria.
...
Mensagem:`
    ...
    function onSubmit(e: React.FormEvent) {
      e.preventDefault();
      setSending(true);
      // Sem backend: abrimos o cliente de email do usuário
        ...
        <Container>
          <div className="mx-auto max-w-2xl rounded-2xl border border-buff/20 bg-night p-6 shadow-[var(--shadow-soft)]">
            ...
            <p className="mt-2 text-center text-buff/80">
              Preencha seus dados que eu entro em contato. Respondo geralmente no mesmo dia útil.
            </p>
            <form onSubmit={onSubmit} className="mt-6 grid grid-cols-1 gap-4">
              <div className="grid gap-1.5">
                <label htmlFor="name" className="text-sm text-buff/70">Nome</label>
                <input
                  id="name"
                  required
                  value={name}
              ...
              <div className="grid gap-1.5">
                <label htmlFor="email" className="text-sm text-buff/70">Email</label>
                <input
                  id="email"
                  required
                  type="email"
              ...
              <div className="grid gap-1.5">
                <label htmlFor="phone" className="text-sm text-buff/70">Celular</label>
                <input
                  id="phone"
                  value={phone}
              ...
              >
                {sending ? "Enviando..." : "Quero saber mais"}
                <Mail className="size-5" />
              </button>
              <p className="text-center text-xs text-buff/60">Ao enviar, um cliente de email abrirá com a mensagem pronta.</p>
            </form>
          </div>
        </Container>
      </Section>
