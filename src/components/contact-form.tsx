...
export function ContactForm() {
    ...
    return (
        <Section id="contato">
            <Container>
                <div
                    className="mx-auto max-w-2xl rounded-2xl border border-buff/20 bg-night p-6 shadow-[var(--shadow-soft)]">
                    ...
                    <form onSubmit={onSubmit} className="mt-6 grid grid-cols-1 gap-4" noValidate>
                        ...
                        >
                            {sending || mutation.isPending ? "Enviando..." : "Quero saber mais"}
                            <Mail className="size-5"/>
                        </button>

                        <p className="text-center text-xs text-buff/60">
                            Seus dados são enviados com segurança e você recebe retorno no seu e-mail.
                        </p>
                    </form>
                </div>
            </Container>
